...
router.post("/getOlist", (req, res) => {
  ...
  db.query(
    "SELECT chat.idchat, chat.senderId, chat.reciverId,  organization.oName, organization.photo from chat left join organization on chat.reciverId= organization.idOrganization where senderId=1 and senderType= 'Organization' AND reciverType = 'Organization' ;",
